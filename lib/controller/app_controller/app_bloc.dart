...
///  AppBloc - Appni boshqarish uchun, til va theme larni o'zgartirish uchun foydalanamiz.
...
class AppBloc extends Bloc<AppEvent, AppState> {
  ...
  /// Bu method [AppRepository] da ThemeModeni o'zgartiradi(dark bo'lsa light ga, light bo'lsa dark ga) va uni [HiveDatabase]ga saqlab qo'yadi.
  ...
  /// Bu method [AppRepository] da [HiveDatabase] ga saqlab qo'yilgan ThemeMode ni qaytaradi(dark yoki light, true qaytsa => dark, false qaytsa => light).
